...
def dibujar_grafo(grafo, nombre_archivo='MetroMexico'):
    """
    ...
    dot = Graph(comment='Metro de México', engine='sfdp', format='png')  # sfdp es mejor para grafos grandes
