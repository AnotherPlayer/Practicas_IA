...
def cargar_grafo(archivo_csv):
    ...
    y devuelve un diccionario de adyacencia con pesos.
    """
...
def obtener_estaciones(grafo):
    """Devuelve la lista de estaciones (nodos) del grafo."""
...
def dibujar_grafo(grafo, nombre_archivo='MetroMadrid'):
    ...
    dot = Graph(comment='Metro de Madrid', engine='sfdp', format='png')  # sfdp es mejor para grafos grandes
